...
Markdown 也确实十分简单易用，30分钟的使用足以上手。
...
```
[图片上传失败...(image-be5271-1538539138548)]

[图片上传失败...(image-cbfa9c-1538539138548)]
```
...
1. typora  适用于windows  ubuntu  MacOS 平台
2. markdown Pad2
...
1. [原文链接](https://github.com/riku/Markdown-Syntax-CN/blob/master/basics.md)