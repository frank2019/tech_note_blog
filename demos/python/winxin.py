...
class weixin_spider:
	...
	def __init__(self, keywords):
		...
		self.sogou_search_url = 'http://weixin.sogou.com/weixin?type=1&query=%s&ie=utf8&s_from=input&_sug_=n&_sug_type_=' % request.quote(self.keywords)
	...
	def get_selenium_js_html1(self, url):
